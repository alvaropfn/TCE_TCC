...
\end{itemize}
  ...
  \begin{table*}[!htbp]
    \centering
    \caption{Vantagens e desvantagens do nivel de fidelidade de prototipos}
    \begin{tabular}{|c|l|l|}
    \hline
  ...
  É comum que o desenvolvimento do sistema de design anteceda um passo de muita importância que é a codificação desse design criando assim uma biblioteca de componentes utilizaveis tanto para ao desenvolvimento do prototipo como do produto. Todas as empresas e entides citadas no inicio do capitulo possuem essa implementação em maior ou menor grau de cobertura dos componentes, algumas em diferentes linguagens de programação para uma ou mais plataformas, como a web ou mobile.
